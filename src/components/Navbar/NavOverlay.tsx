...
const NavOverlay: React.FC<OverlayProps> = ({ toggleMenu, menuLinks }) => {
  ...
  return (
    <nav className="overlay fixed top-0 right-0 h-screen w-screen md:top-4 md:right-2 md:w-fit md:h-[96vh] z-10 rounded-lg text-white border border-white/30 bg-black md:bg-black/70 backdrop-blur-lg overflow-hidden flex justify-between">
